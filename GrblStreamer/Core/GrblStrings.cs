...
{
    /// <summary>
    /// GRBL hata ve alarm mesajları
    /// </summary>
    public static class GrblStrings
    {
        ...
        private static readonly Dictionary<int, string> AlarmMessages = new Dictionary<int, string>
        {
        ...
        /// <summary>
        /// Hata koduna karşılık gelen mesajı döner
        /// </summary>
        public static string GetErrorMessage(int code)
        {
            string message;
            return ErrorMessages.TryGetValue(code, out message) ? message : string.Format("Unknown error: {0}", code);
        }

        /// <summary>
        /// Alarm koduna karşılık gelen mesajı döner
        /// </summary>
        public static string GetAlarmMessage(int code)
        {
            string message;
            return AlarmMessages.TryGetValue(code, out message) ? message : string.Format("Unknown alarm: {0}", code);
        }
    }
}
